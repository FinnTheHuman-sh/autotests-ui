...
class CourseViewMenuComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.edit_menu_item = Button(page, locator='course-view-edit-menu-item', name='Edit')
        self.delete_menu_item = Button(page, locator='course-view-delete-menu-item', name='Delete')
